...
@Service
@ConditionalOnProperty(prefix = "app.file-storage", name = "type", havingValue = "cloudinary")
...
public class CloudinaryFileStorageService implements FileStorageService {
    ...
    public StoredFile storeProductImage(MultipartFile file) {
        ...
        FileStorageProperties.Cloudinary cloudinaryProperties = properties.getCloudinary();
        ...
        try {
            ...
            return new StoredFile(secureUrl, storedPublicId, contentType, file.getSize());
        } catch (IOException ex) {
            throw new IllegalStateException("Could not upload image to Cloudinary", ex);
        }
    }
    ...
    public void delete(String storagePath) {
        ...
        try {
            ...
            throw new IllegalStateException("Could not delete image from Cloudinary", ex);
        }
    }
