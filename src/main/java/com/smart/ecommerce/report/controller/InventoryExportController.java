...
import com.smart.ecommerce.report.service.InventoryReportExportService;
...
@Tag(name = "Admin Inventory PDF Export")
@PreAuthorize("hasRole('ADMIN')")
public class InventoryExportController {
  private final InventoryReportExportService service;
  @GetMapping(value = "/current/export/pdf",
  ...
  current(@RequestParam(required = false) Long productId,
    ...
    return pdf(service.current(new Current(productId, productName, categoryId,
                                           active, stockStatus, minStock,
                                           maxStock, minUnitCost, maxUnitCost),
                               loc()));
  }
  @GetMapping(value = "/low-stock/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  low(@RequestParam(required = false) Long categoryId,
    ...
    return pdf(service.low(categoryId, threshold, active,
                           new Period(period, dateFrom, dateTo), loc()));
  }
  @GetMapping(value = "/out-of-stock/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  out(@RequestParam(required = false) Long categoryId,
      @RequestParam(required = false) Boolean active) {
    return pdf(service.out(categoryId, active, loc()));
  }
  @GetMapping(value = "/valuation/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  valuation(@RequestParam(required = false) Long categoryId,
            @RequestParam(required = false) Boolean active,
            @RequestParam(required = false) StockStatus stockStatus) {
    return pdf(service.valuation(categoryId, active, stockStatus, loc()));
  }
  @GetMapping(value = "/movements/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  ...
  @GetMapping(value = "/products/{productId}/ledger/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  ledger(@PathVariable Long productId,
         ...
         @RequestParam(required = false) LocalDate dateTo) {
    return pdf(
        service.ledger(productId, new Period(period, dateFrom, dateTo), loc()));
  }
  @GetMapping(value = "/never-sold/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  never(@RequestParam(required = false) Long categoryId,
        @RequestParam(required = false) Boolean active,
        @RequestParam(required = false) LocalDate createdBefore) {
    return pdf(service.neverSold(categoryId, active, createdBefore, loc()));
  }
  @GetMapping(value = "/most-adjusted/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  adjusted(@RequestParam(defaultValue = "TODAY") ReportPeriod period,
    ...
    return pdf(service.adjusted(new Period(period, dateFrom, dateTo), limit,
                                sortBy, loc()));
  }
  @GetMapping(value = "/restorations/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  restorations(@RequestParam(defaultValue = "TODAY") ReportPeriod period,
    ...
    return pdf(service.restorations(new Period(period, dateFrom, dateTo),
                                    movementType, loc()));
  }
  @GetMapping(value = "/reconciliation/export/pdf",
              produces = MediaType.APPLICATION_PDF_VALUE)
  public ResponseEntity<ByteArrayResource>
  reconciliation(@RequestParam(defaultValue = "false") boolean onlyMismatched) {
    return pdf(service.reconciliation(onlyMismatched, loc()));
  }
