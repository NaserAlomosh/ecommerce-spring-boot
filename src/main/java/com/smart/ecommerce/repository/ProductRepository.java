...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @EntityGraph(attributePaths = {"category", "images"})
    Page<Product> findByActiveTrueAndCategory_ActiveTrueAndCategory_Id(Long categoryId, Pageable pageable);

    @EntityGraph(attributePaths = {"category", "images"})
    Page<Product> findByActiveTrueAndCategory_ActiveTrueAndFeatured(boolean featured, Pageable pageable);

    @EntityGraph(attributePaths = {"category", "images"})
    Page<Product> findByActiveTrueAndCategory_ActiveTrueAndCategory_IdAndFeatured(Long categoryId, boolean featured, Pageable pageable);
