...
@Table(name="orders", uniqueConstraints=@UniqueConstraint(name="uk_orders_order_number", columnNames="order_number"), indexes={@Index(name="idx_orders_customer", columnList="customer_id"), @Index(name="idx_orders_customer_created", columnList="customer_id,created_at"), @Index(name="idx_orders_customer_status", columnList="customer_id,status"), @Index(name="idx_orders_status", columnList="status"), @Index(name="idx_orders_created", columnList="created_at")})
public class Order extends BaseEntity {
 ...
 @Column(name="delivery_fee", nullable=false, precision=19, scale=3) private BigDecimal deliveryFee;
