...
@Table(name = "customer_addresses",
       indexes =
       {
         @Index(name = "idx_customer_addresses_customer",
                columnList = "customer_id")
         ,
             @Index(name = "idx_customer_addresses_customer_active",
                    columnList = "customer_id,active"),
             @Index(name = "idx_customer_addresses_customer_default",
                    columnList = "customer_id,default_address")
       })
