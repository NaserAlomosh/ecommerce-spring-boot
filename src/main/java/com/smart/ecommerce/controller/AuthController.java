...
public class AuthController {
    ...
    public ApiResponse<Void> verifyEmail(@Valid @RequestBody EmailOtpRequest request) {
    ...
    public ApiResponse<ResetOtpResponse> verifyReset(@Valid @RequestBody EmailOtpRequest request) {
    ...
    public ApiResponse<TokenResponse> social(
