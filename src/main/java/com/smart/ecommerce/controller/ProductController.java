...
public class ProductController {
  ...
  @GetMapping
  public ApiResponse<PaginationResponse<ProductResponse>>
  list(@RequestParam(required = false) Long categoryId,
       @RequestParam(required = false) Boolean featured, Pageable pageable) {
    return ApiResponse.success(
        messages.getMessage("products"),
        productService.listPublic(categoryId, featured, pageable));
  }
